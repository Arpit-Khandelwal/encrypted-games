...
import { TurncloakAuction } from "../target/types/turncloak_auction";
...
describe("TurncloakAuction", () => {
  // Configure the client to use the local cluster.
  anchor.setProvider(anchor.AnchorProvider.env());
  const program = anchor.workspace
    .TurncloakAuction as Program<TurncloakAuction>;
  ...
  async function initAddTogetherCompDef(
    program: Program<TurncloakAuction>,
